...
{:deps {org.clojure/clojure {:mvn/version "1.12.3"}
        org.duct-framework/main {:mvn/version "0.4.2"}}
...
----
{:aliases
 {:duct {:extra-deps {org.duct-framework/main {:mvn/version "0.4.2"}}
...
(defproject org.example/app "0.1.0-SNAPSHOT"
  ...
  :profiles {:duct {:dependencies [[org.duct-framework/main "0.4.2"]]
                    :main duct.main}})
----
